...
#ifdef SKIN
#include "internal/shaders/include/Skin.glsl"
#endif
...
#ifdef USE_BUMP
#include "internal/shaders/include/Normal.glsl"
#endif // USE_BUMP

#ifdef USE_STOCHASTIC
#include "internal/shaders/include/Stochastic.glsl"
...
#ifdef USE_TRIPLANAR
#include "internal/shaders/include/Triplanar.glsl"
#endif // USE_TRIPLANAR
