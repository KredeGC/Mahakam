...
namespace Mahakam
{
	...
	public:
		...
		MeshComponent(Asset<SubMesh> mesh, Asset<Material> material)
		...
		inline Asset<SubMesh> GetSubMesh() { return m_SkinnedMesh->Meshes.at(0); }
		inline const std::vector<Asset<SubMesh>>& GetSubMeshes() { return m_SkinnedMesh->Meshes; }
