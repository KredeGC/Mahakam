...
namespace Mahakam
{
	...
	void ImGuiLayer::OnAttach()
	{
		...
		// Default font
		io.FontDefault = io.Fonts->AddFontFromFileTTF("internal/fonts/Roboto/Roboto-Regular.ttf", 16.0f);
		...
		io.Fonts->AddFontFromFileTTF("internal/fonts/IcoFont/icofont.ttf", 16.0f, &config, icon_ranges);

		// Mono font
		ImFontConfig monoConfig;
		monoConfig.GlyphMinAdvanceX = 8.0f;
		monoConfig.GlyphMaxAdvanceX = 8.0f;
		m_MonoFont = io.Fonts->AddFontFromFileTTF("internal/fonts/ProggyVector/ProggyVector Regular.ttf", 15.0f, &monoConfig);
