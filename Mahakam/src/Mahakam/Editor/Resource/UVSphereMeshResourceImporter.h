...
namespace Mahakam
{
	...
	class UVSphereMeshResourceImporter : public ResourceImporter
	{
	private:
		UVSphereMeshProps m_Props;

		Asset<Mesh> m_PreviewMesh;

	public:
		UVSphereMeshResourceImporter();
	...
	private:
		UVSphereMeshProps DeserializeProps(ryml::NodeRef& node);
	};
}